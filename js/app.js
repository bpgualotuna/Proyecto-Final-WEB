...
// Función autoejecutable para iniciar la aplicación
// Implementa el patrón IIFE (Immediately Invoked Function Expression)
...
(function iniciarAplicacion() {
  ...
  function init() {
    try {
      // Crear y inicializar el controlador principal
  ...
  // Muestra un error crítico en la interfaz
